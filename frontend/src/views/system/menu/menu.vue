            ...
            <s-layout-tools>
                ...
                <template #right>
                    <a-space wrap>
                        ...
                        <a-button @click="selectCurrentMenuList" :disabled="!currentMenuKeys.length">
                            <span>选中当前列表</span>
                        </a-button>

                        <a-button @click="clearMenuSelection" :disabled="!selectedKeys.length">
                            <span>取消选中</span>
                        </a-button>
...
const selectCurrentMenuList = () => {
    selectedKeys.value = [...currentMenuKeys.value];
};
...
const onDelete = async (row: any) => {
    try {
        ...
        selectedKeys.value = selectedKeys.value.filter((item) => item !== Number(row.id));
        getMenuList();
