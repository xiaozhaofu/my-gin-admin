...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    SelectArea: typeof import('./components/select-area/index.vue')['default']
    SelectDepartment: typeof import('./components/select-department/index.vue')['default']
    SelectUser: typeof import('./components/select-user/index.vue')['default']
